...
class MainWindow():
    ...
    def initializeUI(self):
        ...
        requestView = Listbox(self.leftFrame, height=17, width=20, selectmode=SINGLE, yscrollcommand=requestScroll.set)
        requestScroll.config(command=requestView.yview)
        requestScroll.grid(row=1, column=0, sticky="NS")
        requestView.grid(row=1, column=1, padx=5, columnspan=2)
    ...
    def removeStudent(self):
        self.availableView.insert(END, self.assignedView[self.assignedView.curselection()[0]])
